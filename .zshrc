...
export PATH="$HOME/bin:$HOME/.local/bin:$HOME/.programs/bin:$HOME/.programs/go/bin:$HOME/prog/go/bin:$HOME/.cargo/bin:$HOME/.cabal/bin:$HOME/.ghcup/bin:/snap/bin:$NPM_PACKAGES/bin:$PATH"
export GPG_TTY=$(tty)
